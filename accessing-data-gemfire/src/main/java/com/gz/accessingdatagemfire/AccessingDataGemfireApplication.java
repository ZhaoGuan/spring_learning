...
public class AccessingDataGemfireApplication {
    ...
    ApplicationRunner run(PersonRepository personRepository) {
        return args -> {
            ...
            Person bob = new Person("Baby Bod", 1);
            Person carol = new Person("Tenn Carol", 13);
            ...
            System.out.println("Query teems (between 12 and 20):");

            stream(personRepository.
                    findByAgeGreaterThanAndAgeLessThan(12, 20).spliterator(), false)
                    .forEach(person -> System.out.println("\t" + person));
        };
    }
}
